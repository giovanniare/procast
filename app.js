...
app.get('/desarrollos', (req, res) => {
    res.render('desarrollos', {
        imageHeader: 'des',
        titulo: 'DESARROLLOS',
        descripcion: 'En PROCAST REAL ESTATE la Arquitectura es un todo',
...
app.get('/servicios', (req, res) => {
    res.render('servicios', {
        ...
        titulo: 'SERVICIOS',
        descripcion: 'En PROCAST REAL ESTATE ofrecemos servicios integrales',
